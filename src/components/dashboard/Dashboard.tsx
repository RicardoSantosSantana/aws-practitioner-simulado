...
function Copyright(props: any) {
  return (
    <Typography variant="body2" color="text.secondary" align="center" {...props}>
      {'Copyright © '}
      <Link color="inherit" href="https://premium.recibonline.com.br/">
...
function DashboardContent({children,show}) {
        ...
        <AppBar position="absolute" open={open}>
          <Toolbar    sx={{   pr: '24px',   }} >
            ...
            <Typography
              ...
              sx={{ flexGrow: 1 }}
            >
              { show=="true" ? total +" - " : '' } Perguntas para estudo AWS Practitioner 
            </Typography>
            
     { show=="true" ? mostrarContadores : '' }
...
export default function Dashboard( { children, show } ) {  
  return <DashboardContent show={show}>{children}</DashboardContent>;
}