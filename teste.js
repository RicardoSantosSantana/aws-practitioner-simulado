dados =[
    {
     ...
     "resposta": "C – A capacidade de executar instâncias <strong>sob demanda</strong> quando necessário permite que os usuários executem e encerrem instâncias em resposta a uma workload variável. Essa é uma prática mais econômica do que comprar servidores on-premises suficientes para lidar com o pico de carga."
     },
     ...
     },
     {
         ...
         "resposta": "A – <strong>O Amazon SNS</strong> e o <strong>Amazon CloudWatch</strong> são integrados para que os usuários possam coletar, visualizar e analisar métricas para cada SNS ativo. Depois que os usuários configuram o CloudWatch para o Amazon SNS, eles podem obter um insight melhor sobre a performance dos tópicos, notificações por push e entregas por SMS do <strong>Amazon SNS.</strong>"
     },    
     {
         ...
         "resposta": "D – <strong>A política de uso aceitável da AWS</strong> fornece informações sobre ações proibidas na infraestrutura da AWS. " 
     },
     {
     ...
     },
     {
         ...
         "opcoes":[
             ...
             {"B) Teremos uma redução de custo ao londo do tempo, diminuindo o Opex e aumentnado o Capex":false},
             {"C) Não teremos uma redução de custo, porque o Capex é maijor que o Opex":false},
     ...
     },
     {
         ...
         "opcoes":[
             {"A) <strong>Still Guessing: </strong> Ir para a Nuvem é fazer várias tentaticas até encontrar o melhor poder computacional":false},
             {"B) <strong>Go Global in minutes: </strong> Você não precisa mais esperar a compra de um novo servidor para melhorar seu desempenho. Na Nuvem você escolhe um serviço, configura e já começa a usar.":true},
             {"C) <strong>Slow Speed:</strong> Ir para a Nuvem é enfrentar latência, mas é um ambiente muito seguro.":false},
             {"D) <strong>Expensive:</strong> Ir para a Nuvem pode ser caro no começo, mas possui vantagens competitivas.":false}
         ],
     ...
     },
     {
         ...
         "opcoes":[
             {"A) <strong>Tradicional</strong>":false},
             {"B) <strong>IaaS</strong> Infraestrutura como Serviço ":true},
             {"C) <strong>SaaS</strong> Software como Serviço":false},
             {"D) <strong>PaaS</strong> Plataforma como Serviço ":false}
         ],
     ...
     },
     {
         ...
         "opcoes":[
             {"A) While the AWS manages security <strong>IN</strong> the cloud, you are responsible for security <strong>OF</strong> the cloud.":true},
             {"B) While the AWS manages security <strong>OF</strong> the cloud, you are responsible for security <strong>IN</strong> the cloud.":true},
             {"C) While the AWS manages security <strong>OF</strong> the cloud, you are responsible for security <strong>OF</strong> the cloud.":false},
             {"D) While the AWS manages security <strong>IN</strong> the cloud, you are responsible for security <strong>IN</strong> the cloud.":false}
         ],
     ...
     },
     {
         ...
         "opcoes":[
             {"A) <strong>Sim, </strong>é só agendar uma visita via página da AWS. E os relatórios de conformidade podem ser obtidos no <strong>AWS Artifact.</strong>":false},
             {"B) <strong>Não, </strong>as visitar são proibidas. Porém a AWS é continuamente auditada e os relatórios de confirmidade podem ser obtidos no <strong>AWS Artifact.</strong>":true}
         ],
     ...
     },
     {
         ...
         "resposta": "D - Sim, uma conta <strong>Free Tier</strong> é o conjunto de três tipos de ofertas: Os do tipo sempre gratuitos, os que expiram em 12 meses e os de testes de curto prazo." 
     },
     {
     ...
     },    
     {
         ...
         "resposta": "C - Sim, o <strong>AWS WAF</strong> é um firewall de aplicativos web." 
     },
     {
         ...
         "resposta": "A - <strong>IAM</strong> significa: Identity and Access Management." 
     },
     {
     ...
     },
     {
         ...
         "resposta": "D - Sim, o <strong>Security Group</strong> é um firewall virtual da AWS, utilizado em instâncias EC2." 
     },
     {
     ...
     },
     {
         ...
         "resposta": "C - Sim, o <strong>AWS Lambda</strong> permite que você execute código sem provisionar ou gerenciar servidores. Você paga apenas pelo tempo de computação consumido." 
     },
     {
         ...
         "resposta": "C - O <strong>Amazon Lightsail</strong> é uma plataforma de nuvem fácil de usar, que oferece tudo o que você precisa para criar uma plataforma WordPress, além de um plano mensal de baixo custo." 
     },
     {
         ...
         "resposta": "B - Sim, o <strong>AWS Elastic Beanstalk</strong> é um serviço gerenciado e voltado para desenvolvedores que precisam subir uma aplicação na WEB, sem se preocupar com a infraestrutura." 
     },
     {
     ...
     },
     {
         ...
         "resposta": "C - O Amazon Simple Storage Service (<strong>Amazon S3</strong>) é um serviço de armazenamento de objetos que oferece escalabilidade, disponibilidade de dados, segurança e performance líderes do setor. Isso significa que clientes de todos os tamanhos e setores podem usá-lo para armazenar e proteger qualquer volume de dados em vários casos de uso, como data lakes, sites, aplicações para dispositivos móveis, backup e restauração, arquivamento, aplicações empresariais, dispositivos IoT e análises de big data. O <strong>Amazon S3</strong> fornece recursos de gerenciamento fáceis de usar, de maneira que você possa organizar os dados e configurar os controles de acesso refinados para atender a requisitos específicos comerciais, organizacionais e de conformidade. O <strong>Amazon S3</strong> foi projetado para <strong> 99,999999999% (11 noves)</strong> de durabilidade e armazena dados de milhões de aplicações para empresas em todo o mundo." 
     },
     {
         "pergunta": "O técnico da sua empresa após criar um volume Amazon EBS, não conseguiu anexar na instância EC2 porque o volume desapareceu. <br><strong>Qual é o motivo?</strong>",
         "opcoes":[
         ...
         "resposta": "A - Lembre-se de sempre criar o volume <strong>Amazon EBS</strong>, na mesma zona de disponibilidade da sua instância." 
     },
     {
         ...
         "resposta": "B - O <strong>AWS Snowball</strong> é um dispositivo de computação, migração de dados e armazenamento de borda na escala de petabytes." 
     },
     {
     ...
     },
     {
         ...
         "resposta": "B - O <strong>Amazon EBS</strong> é comparado a um disco rígido que é conectado em instâncias do Amazon EC2." 
     },
     {
         ...
         "resposta": "B - O <strong>Amazon S3 Glacier</strong> é para armazenamento a longo prazo, e quando solicitado a recuperação de um arquivo ele pode levar até 12 horas para recuperá-lo." 
     },
     {
         ...
         "resposta": "B - O <strong>AWS Elastic File System</strong> é um sistema de arquivos NFS que permite compartilhar dados em múltiplas zonas de disponibilidade da mesma região." 
     },
     {
         ...
         "resposta": "C - <strong>O Instance Store</strong> é um armazenamento efêmero (do Inglês, ephemeral storage), que não pode ser desconectado e que quando a instância é desligada, todos os dados são perdidos." 
     },
     {
     ...
     },
     {
        ...
        "resposta": "A - Você pode comprar e gerenciar nomes de domínio (como meusite.com) e o <strong>Amazon Route 53</strong> configura automaticamente as definições de DNS para os seus domínios." 
    },
    {
        ...
        "resposta": "A - Sim, os <strong>ponto de presença</strong> (POP, do inglês Point of Presence) são importantes porque eles atuam como cache." 
    },
    {
        ...
        "resposta": "C - A <strong>Amazon Virtual Private Cloud (Amazon VPC) </strong> permite executar os recursos da AWS em uma rede virtual definida por você. Essa rede virtual se assemelha a uma rede tradicional que você operaria no seu datacenter, com os benefícios de usar a infraestrutura dimensionável da AWS." 
    },
    {
    ...
    },
    {
        ...
        "resposta": "O <strong>Amazon RDS</strong> é um banco relacional. Sua sigla em Inglês significa: Relational Database Service" 
    },
    {
    ...
    },
    {
        ...
        "resposta": "C - Habilitar o <strong>Amazon ElastiCache</strong>, permitirá o armazenamento de dados na memória e a responder as requisições em menos de um (01) milissegundo." 
    },
    {
        ...
        "resposta": "C - <strong>Amazon DynamoDB.</strong> Serviço de banco de dados NoSQL, rápido e flexível para performance abaixo de 10 milissegundos em qualquer escala." 
    },
    {
        ...
        "resposta": "C - Os planos 'mais caros', que são o Enterprise e o Business, concedem acesso completo no <strong>Trusted Advisor.</strong>" 
    },
    {
    ...
    },
    {
        ...
        "resposta": "A - Se na sua prova pedir para medir o desempenho (do Inglês, performance), associe com um cronômetro. E o serviço que realiza essa atividade é o <strong>AWS CloudWatch.</strong>" 
    },
    {
        ...
        "resposta": "C - <strong>CloudFormation</strong> permite modelar, provisionar e gerenciar recursos da AWS e de terceiros ao tratar a infraestrutura como código." 
    },
    {
    ...
    {
        "pergunta": "No <strong>Amazon SNS</strong>, quais são os dois tipos de clientes?",
        "opcoes":[
    ...
    },
    {
        ...
        "resposta": "A - O <strong>Amazon Simple Queue Service (Amazon SQS)</strong> é um web service que disponibiliza a você acesso a filas de mensagens que armazenam mensagens esperando processamento. Com o <strong>Amazon SQS</strong>, você pode criar rapidamente aplicações de enfileiramento de mensagens executáveis em qualquer computador." 
    },
    {
        ...
        "resposta": "D - O <strong>Amazon SQS</strong> é um serviço de filas de mensagens gerenciado que permite o desacoplamento e a escalabilidade de microsserviços, sistemas distribuídos e aplicativos sem servidor." 
    },
    {
    ...
    },
    {
        ...
        "resposta": "B - O <strong>Amazon SNS </strong> utiliza do <strong>paradigma pub/sub</strong> (publisher e subscriber), que significa Editores e Assinantes (ou inscritos). O Editor cria um tópico e os Assinantes se inscrevem (ou assinam) neste tópico para receber notificações." 
    }
  ];
 
  function filtro(pergunta){
 
    return dados.filter(el=>{
        return el.pergunta == pergunta 
    })
  }
const pergunta = "Por que a AWS é mais econômica do que os datacenters tradicionais para aplicações com diferentes workloads de computação?";
  console.log(filtro(pergunta))